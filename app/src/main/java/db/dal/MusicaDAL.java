...
{   GeneroDAL gdal=new GeneroDAL(context);
    ...
    public ArrayList <Musica> getMusicas(String filtro)
    {   GeneroDAL gdal=new GeneroDAL(context);
        ArrayList <Musica> objs = new ArrayList();
        String sql="select * from "+TABLE;
        if (!filtro.equals(""))
            sql+=" where mus_titulo like "+filtro+"";
    ...
    public ArrayList <Musica> getGenero(int chave)
    {   GeneroDAL gdal=new GeneroDAL(context);
        ArrayList <Musica> objs = new ArrayList();
        String sql="select * from "+TABLE+" where mus_genero = "+ chave;
